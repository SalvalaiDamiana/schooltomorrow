...
var data = [
    [na,na,na,na,na,na,na,na,na,na],//sunday
	[b,b,c,f,f,c,f,na,na,na],
    [b,b,c,c,c,f,c,f,na,na],
    [f,f,c,f,c,c,c,f,na,na],
    [f,f,c,na,na,f,c,na,na,na],
    [b,b,c,f,b,c,na,f,na,na], 
    [na,na,na,na,na,na,na,na,na,na]]; //saturday
...
/*Calendar*/
for (var i = 0; i <10; i++){ /* For every row (hour)*/
    var tr = document.createElement('tr');   
    for(var k  = 0 ; k < 7 ; k++){ /* For every column (day)*/
        ...
        var text = document.createTextNode((i + 8) + ":00 - " + (i + 8) + ":30");
...
function updateColumn(i){
    for(var k = 0; k < 10; k++){
      data[k][i] = na;
      document.getElementById('hour-' + k + '-' + i).classList.remove("notav");
      document.getElementById('hour-' + k + '-' + i).className = "free";
    }
}
